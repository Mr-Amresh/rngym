      ...
      <div className="footer__container  container">
        <div className="footer__content">
          <div className="footer__box">
            <Link to="/" className="footer__logo">
              <p className="footer__logo-text">RN GYM</p>
            </Link>
          ...
          <div className="footer__box">
            ...
            <div className="footer__contact">
              ...
              <a
                ...
                href="https://maps.app.goo.gl/3Y3ZxZxXJ3xZxZxZ7"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="footer__contact">
              ...
              <a className="footer__link" href="tel:0000000000">
                (123) 1234 567 000
              </a>
            </div>
          </div>
        ...
        <div className="footer__date">
          <p>
            ...
            <span className="footer__logo-name"> RN GYM </span>
            All Rights Reserved.
          </p>
